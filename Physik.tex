...
\begin{sectionbox}
	...
	\begin{cookbox}{Newton'sche Axiome}
		...
		\item $F=m  a=\frac{\diff p}{\diff t}=\dot{p}$
		\item $F_{12}=-F_{21}$
	\end{cookbox}
...
\begin{sectionbox}
	...
	\subsubsection{Kraft}
	\begin{tablebox}{ll}
		Federkraft & $F_F=-k(\vec x - \vec x_0)$ \\ & $\vec x:$ Ort der Auslenkung, $\vec x_0$ Gleichgewichtspunkt \\
...
\begin{sectionbox}
	...
	$M=F\times r=F  r  \sin \alpha$\\
	$M=I  \dot{\omega}=\frac{\diff L}{\diff t}$
