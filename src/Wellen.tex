\begin{sectionbox}
    ...
    \textbf{Allgemeine Wellengleichung:} $\frac{1}{c^2}\frac{\partial^2u}{\partial t^2}=\frac{\partial^2u}{\partial x^2}$\\
...
\begin{sectionbox}
    ...
    \begin{cookbox}{}
        ...
        mit $\alpha$: Öffnungswinkel des Machschen Kegels (TODO: $\diff w, \diff s$)
    \end{cookbox}
\end{sectionbox}
